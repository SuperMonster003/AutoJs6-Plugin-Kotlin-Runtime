...
* [CHANGELOG-zh-Hant-TW.md](https://github.com/SuperMonster003/AutoJs6-Plugin-Kotlin-Runtime/blob/main/.changelog/CHANGELOG-zh-Hant-TW.md)
...
建置參數集中於 `version.properties`: 目前版本 0.7.0-m10 (build 7), minSdk 26, targetSdk 36.
